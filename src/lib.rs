...
#[derive(Debug)]
pub struct NeuralNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeuralNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeuralNode processing");
    
    let mut processor = NeuralNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeuralNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeuralNodeProcessor::new(false);
